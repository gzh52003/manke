<template>
    <div>
        ...
        <el-input placeholder="请输入内容" icon="search" clearable v-model="input" :on-icon-click="handleIconClick"
            style="width:38%">
        ...
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
            :current-page.sync="currentPage3" :page-size="6" layout="prev, pager, next, jumper" :total="res">
        </el-pagination>
    </div>
</template>
<script>
