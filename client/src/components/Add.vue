            ...
            >
              <el-tab-pane label="基本信息" name="0">
                ...
                <!-- <template> -->
                  ...
                  <el-option lable="aaa" value="漫画" @click.native=aaa()>
                  </el-option>
                  <el-option lable="aaa" value="小说">
                  </el-option>
                  <el-option lable="aaa" value="故事">
                  </el-option>
                  </el-select>
                <!-- </template> -->
              </el-tab-pane>
...
export default {
  data () {
    return {
      ...
      onlyTableData: [],
      // 图片上传地址
      uploadURL: 'http://localhost:8080/api/private/v1/upload',
      // 图片上传组件的请求对象
      headerObj: {
